...
For DR failback, Cloud must also own target Mold selection and target primary VM lifecycle. The target Mold may be the current Mold, the original primary Mold, or a newly installed Mold, as defined for source-controller failback in [206. DR Cloud-Managed Failback Target Mold Design](206-dr-cloud-managed-failback-target-mold-design-20260516.md). If the source Mold is unavailable, the replica Mold must use the replica-site controller model from [208. DR Replica-Site Disaster Failback And Adoption Design](208-dr-replica-site-disaster-failback-and-adoption-design-20260517.md).
